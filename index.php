...
<head>
  ...
  <title>Skibidi Telolet Villa</title>
  ...
  <div class="contact-content">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-5">
          <form id="contact-form" action="actions.php" method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="col-lg-12">
                <fieldset>
                  <label for="name">Image</label>
                  <input type="file" name="image" id="image" placeholder="Your Image..." required>
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
